...
namespace Project2 {
	...
	/// <summary>
	/// Summary for PatientRegisterForm1
	/// </summary>
	public ref class PatientRegisterForm1 : public System::Windows::Forms::Form
	{
	public:
		PatientRegisterForm1(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PatientRegisterForm1::typeid));
			...
			this->button1->Location = System::Drawing::Point(85, 359);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(98, 34);
			this->button1->TabIndex = 28;
			this->button1->Text = L"Submit";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &PatientRegisterForm1::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(28, 100);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(87, 259);
			...
			this->label4->Location = System::Drawing::Point(26, 163);
			...
			this->button2->Location = System::Drawing::Point(290, 359);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(85, 320);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(87, 128);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(85, 195);
			...
			this->pictureBox1->Location = System::Drawing::Point(24, 84);
			...
			this->linkLabel1->Location = System::Drawing::Point(935, 22);
			this->linkLabel1->Name = L"linkLabel1";
			this->linkLabel1->Size = System::Drawing::Size(128, 41);
			this->linkLabel1->TabIndex = 27;
			this->linkLabel1->TabStop = true;
			this->linkLabel1->Text = L"Return";
			this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &PatientRegisterForm1::linkLabel1_LinkClicked);
			// 
			// label3
			// 
			...
			this->Name = L"PatientRegisterForm1";
			this->Text = L"PatientRegisterForm1";
			this->Load += gcnew System::EventHandler(this, &PatientRegisterForm1::PatientRegisterForm1_Load);
...
private: System::Void PatientRegisterForm1_Load(System::Object^ sender, System::EventArgs^ e) {
}
